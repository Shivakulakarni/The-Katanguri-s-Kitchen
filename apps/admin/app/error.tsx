...
export default function Error({
  ...
  useEffect(() => {
    console.error('[Telemetry] Admin Dashboard exception:', error);
  }, [error]);
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: '36px', animation: 'pulse 2s infinite' }}>⚙️</span>
        </div>
        ...
        <p style={{
          ...
          A supervisor process isolated a dashboard exception. Session state has been preserved.
        </p>
        ...
        <div style={{ width: '100%', textAlign: 'left' }}>
          ...
          {showLogs && (
            <div style={{
              ...
              <div><strong>Console Status:</strong> Isolated Exception</div>
              <div style={{ marginTop: '4px' }}><strong>Trace Digest:</strong> {error.digest || 'DASHBOARD-ERR-UNRESOLVED'}</div>
